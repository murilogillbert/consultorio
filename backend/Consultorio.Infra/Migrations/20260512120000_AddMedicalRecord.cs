...
namespace Consultorio.Infra.Migrations
{
    ...
    public partial class AddMedicalRecord : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "OTHER"),
        ...
        {
            migrationBuilder.DropTable(name: "MedicalRecordAudits");
            migrationBuilder.DropTable(name: "MedicalAttachments");
