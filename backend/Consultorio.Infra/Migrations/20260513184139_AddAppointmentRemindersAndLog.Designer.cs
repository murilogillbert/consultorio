...
namespace Consultorio.Infra.Migrations
{
    ...
    [Migration("20260513184139_AddAppointmentRemindersAndLog")]
    partial class AddAppointmentRemindersAndLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.Appointment", b =>
                {
                    ...
                    b.Property<string>("PatientConfirmation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.AppointmentReminderLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AppointmentId", "ReminderType", "Status");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.Custo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ClinicId", "DataCompetencia");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.MedicalAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.MedicalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.MedicalRecordAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.SessionNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.Category", b =>
                {
                    ...
                    b.HasOne("Consultorio.Domain.Models.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.MedicalAttachment", b =>
                {
                    ...
                    b.HasOne("Consultorio.Domain.Models.MedicalRecord", "MedicalRecord")
                    ...
                    b.HasOne("Consultorio.Domain.Models.SessionNote", "SessionNote")
                        .WithMany()
                        .HasForeignKey("SessionNoteId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Consultorio.Domain.Models.User", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Consultorio.Domain.Models.MedicalRecord", b =>
                {
                    ...
                    b.HasOne("Consultorio.Domain.Models.Patient", "Patient")
                        ...
                        .HasForeignKey("Consultorio.Domain.Models.MedicalRecord", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Consultorio.Domain.Models.User", "UpdatedBy")
                        .WithMany()
