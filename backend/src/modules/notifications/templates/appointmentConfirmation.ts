...
<title>Confirmacao de Consulta</title>
</head>
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr><td style="padding:32px;">
          <p style="margin:0 0 24px;font-size:16px;color:#374151;">Ola, <strong>${data.patientName}</strong>!</p>
          ...
          <table width="100%" cellpadding="12" cellspacing="0" style="background:#f9fafb;border-radius:6px;border:1px solid #e5e7eb;">
            ...
            <tr><td style="color:#6b7280;font-size:13px;border-bottom:1px solid #e5e7eb;">Servico</td>
            ...
            <tr><td style="color:#6b7280;font-size:13px;">Horario</td>
                <td style="color:#111827;font-size:14px;font-weight:600;text-align:right;">${data.time}</td></tr>
            ${data.address ? `<tr><td style="color:#6b7280;font-size:13px;border-top:1px solid #e5e7eb;">Local</td><td style="color:#111827;font-size:14px;font-weight:600;text-align:right;border-top:1px solid #e5e7eb;">${data.address}</td></tr>` : ''}
          </table>
          <p style="margin:24px 0 0;font-size:14px;color:#9ca3af;text-align:center;">Em caso de imprevistos, entre em contato com antecedencia.</p>
        </td></tr>
...
• Data: ${data.date}
• Horario: ${data.time}${data.address ? `\n• Local: ${data.address}` : ''}

Em caso de imprevistos, entre em contato com antecedencia.
